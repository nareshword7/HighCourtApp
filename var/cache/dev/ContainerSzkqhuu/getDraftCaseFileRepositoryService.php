...
// Returns the private 'App\Repository\DraftCaseFileRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DraftCaseFileRepository.php';

return $this->services['App\Repository\DraftCaseFileRepository'] = new \App\Repository\DraftCaseFileRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
