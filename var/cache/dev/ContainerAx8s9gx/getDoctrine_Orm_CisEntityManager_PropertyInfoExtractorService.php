...
// Returns the private 'doctrine.orm.cis_entity_manager.property_info_extractor' shared service.
...
return $this->services['doctrine.orm.cis_entity_manager.property_info_extractor'] = new \Symfony\Bridge\Doctrine\PropertyInfo\DoctrineExtractor(${($_ = isset($this->services['doctrine.orm.cis_entity_manager']) ? $this->services['doctrine.orm.cis_entity_manager'] : $this->load('getDoctrine_Orm_CisEntityManagerService.php')) && false ?: '_'}->getMetadataFactory());
