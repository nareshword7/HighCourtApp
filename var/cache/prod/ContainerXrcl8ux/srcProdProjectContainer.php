...
class srcProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->methodMap = array(
            ...
            'monolog.handler.deprecation' => 'getMonolog_Handler_DeprecationService',
            'monolog.handler.deprecation_filter' => 'getMonolog_Handler_DeprecationFilterService',
    ...
    {
        return $this->services['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('dT91lVZ4wR', NULL, $this->getParameter('container.build_id'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'});
    }
    ...
    {
        $this->services['monolog.handler.deprecation'] = $instance = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'/log/prod.deprecations.log'), 100, true, NULL);
    ...
    {
        $this->services['monolog.handler.deprecation_filter'] = $instance = new \Monolog\Handler\FilterHandler(${($_ = isset($this->services['monolog.handler.deprecation']) ? $this->services['monolog.handler.deprecation'] : $this->getMonolog_Handler_DeprecationService()) && false ?: '_'}, 100, 200, true);
    ...
    protected function getMonolog_Logger_PhpService()
    {
        ...
        $instance->pushHandler(${($_ = isset($this->services['monolog.handler.deprecation_filter']) ? $this->services['monolog.handler.deprecation_filter'] : $this->getMonolog_Handler_DeprecationFilterService()) && false ?: '_'});
        $instance->pushHandler(${($_ = isset($this->services['monolog.handler.console']) ? $this->services['monolog.handler.console'] : $this->services['monolog.handler.console'] = new \Symfony\Bridge\Monolog\Handler\ConsoleHandler(NULL, true, array())) && false ?: '_'});
        $instance->pushHandler(${($_ = isset($this->services['monolog.handler.main']) ? $this->services['monolog.handler.main'] : $this->getMonolog_Handler_MainService()) && false ?: '_'});
